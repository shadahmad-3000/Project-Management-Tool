...
const addUserValidation = Joi.object({
  ...
  empID: Joi.string().alphanum().required().messages({
...
const assignRoleValidation = Joi.object({
  body: Joi.object({
    ...
    role: Joi.string()
      ...
      .messages({
        "any.only":
          "Role must be one of User, Admin, Super-Admin, Manager, Team-Lead, HR",
...
const createProjectValidation = Joi.object({
  body: Joi.object({
    ...
    projectCode: Joi.string()
      .required()
      .messages({ "string.empty": "Project Code is required" }),
    startDate: Joi.date()
      .iso()
      .required()
      .messages({ "date.base": "Start Date must be valid ISO date" }),
    endDate: Joi.date()
      .iso()
    ...
    createdBy: Joi.string()
      .required()
      .messages({ "string.empty": "CreatedBy is required" }),
...
const createTaskValidation = Joi.object({
  body: Joi.object({
    ...
    taskId: Joi.string()
      .required()
      .messages({ "string.empty": "Task ID is required" }),
    description: Joi.string()
      .required()
      .messages({ "string.empty": "Description is required" }),
    assignedBy: Joi.string()
      .required()
      .messages({ "string.empty": "AssignedBy is required" }),
    ...
    taskduration: Joi.string()
      .required()
      .messages({ "string.empty": "Task Duration is required" }),
  ...
  body: Joi.object({
    ...
    updateTask: Joi.object({
      ...
      taskStatus: Joi.string()
        .valid("Not Started", "Pending", "In Progress", "Completed", "On Hold")
        .optional(),
      taskduration: Joi.string().optional(),
      taskDeadline: Joi.object({
        startDate: Joi.date().optional(),
        endDate: Joi.date().min(Joi.ref("startDate")).optional(),
      }).optional(),
      taskPriority: Joi.string().valid("Low", "Medium", "High").optional(),
      halfTimeNotified: Joi.boolean().optional(),
      deadlineMissedNotified: Joi.boolean().optional(),
    })
      .required()
      .messages({
        "object.base": "updateTask must be an object with valid fields",
      }),
  }),
  query: Joi.object({}),
  params: Joi.object({}),
